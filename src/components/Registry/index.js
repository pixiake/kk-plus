...
const Registry = () => {
    ...
    const [initValue] = useState(getRegistryConfig(configuration.registry, 'default'))
    ...
    const onChange = () => {
        ...
        switch (registry.type) {
            ...
            case "custom": {
                ...
                form.setFieldsValue(getRegistryConfig(configuration.registry, 'custom'))
                break
            }
            case "registry": {
                setDisabled({
                ...
                form.setFieldsValue(getRegistryConfig(configuration.registry, 'registry'))
                break
            }
            case "harbor": {
                setDisabled({
                ...
                form.setFieldsValue(getRegistryConfig(configuration.registry, 'harbor'))
                break
            }
        }
    };
